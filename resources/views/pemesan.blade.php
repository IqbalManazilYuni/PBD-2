        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                <main>
                    ...
                    <form class="border">
                        <div>
                            <h1 class="mt-4 font-1">List Data Transaksi</h1>
                        </div>
                        <div class="container">
                            <div class="row">
                            @if(auth()->user()->role == 'admin')
                              <div class="col">
                                <div class="d-flex align-items-center justify-content-between mt-4 mb-0 posisi6A">
                                    <a class="btn btn-info posisi5A" href="{{ route('exportpdffaktur') }}">Export </a>
                                </div>
                              </div>

                              <div class="col">
                                <div class="d-flex align-items-center justify-content-between mt-4 mb-0 posisi6">
                                    <a class="btn btn-primary posisi5" href="{{ route('tambahtransaksi') }}">Tambah</a>
                                </div>
                              </div>
                              @endif
                            </div>
                                    ...
                                    <tbody>
                                        ...
                                        @endphp
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if(auth()->user()->role == 'admin')
                                                    <a href="/deletedatatransaksi/{{ $post->id }}" class="btn btn-danger">Delete</a>
                                                    <a href="/tampildatapemesan/{{ $post->id }}" class="btn btn-success">Edit Pemesan</a>
                                                    <a href="/tampildatatransaksi/{{ $post->id }}" class="btn btn-info">Change Status</a>
                                                    @endif
                                                </td>
                                              </tr>
                                            @endforeach
