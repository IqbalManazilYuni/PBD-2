        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                <main>
                    ...
                    <form class="border" action="/updatedatapemesan/{{ $postpemesan->id }}" method="post" >

                        {{ csrf_field() }}
                        <h1 class="font-1 mt-4 ">Create Data Pemesan</h1>
                        <div class="posisi2">
                              <div class="mb-3">
                                <label for="formGroupExampleInput2" class="form-label">Nama Pemesan</label>
                                <input type="text" class="form-control" name="namapemesan" placeholder="Inputkan Nama Pemesan" value="{{ $postpemesan->namapemesan }}">
                              </div>
                              <div class="mb-3">
                                <label for="formGroupExampleInput2" class="form-label">Alamat Pemesan</label>
                                <input type="text" class="form-control" name="alamat" placeholder="Inputkan Alamat Pemesan" value="{{ $postpemesan->alamat }}">
                              </div>
