        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                <main>
                    ...
                    <form class="border" action="/updatedatabarang/{{ $postbarang->id}}" method="post" >

                        {{ csrf_field() }}
                        <h1 class="font-1 mt-4 ">Edit Data Barang</h1>
                        <div class="posisi2">
                              <div class="mb-3">
                                <label for="formGroupExampleInput2" class="form-label">Nama Barang</label>
                                <input type="text" class="form-control" name="namabarang" placeholder="Inputkan Nama Barang" value="{{ $postbarang->namabarang }}">
                              </div>
                              <div class="mb-3">
                                <label for="formGroupExampleInput2" class="form-label">Harga Barang</label>
                                <input type="number" class="form-control" name="hargabarang" placeholder="Inputkan Harga Barang" value="{{ $postbarang->hargabarang }}">
                              </div>
                              <div class="mb-3">
                                <label for="formGroupExampleInput2" class="form-label">Jumlah Barang</label>
                                <input type="number" class="form-control" name="jumlahbarang" placeholder="Inputkan Jumlah Barang" value="{{ $postbarang->jumlahbarang }}">
                              </div>
                              <button type="submit" class="btn btn-outline-primary posisi3" >Update</button>
                        </div>
                    </form>
                </main>
            </div>
