                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-7">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        <form class="form-control" action="{{ route('postregister') }}" method="post">
                                            {{ csrf_field() }}
                                            <div class="form-floating mb-3 mb-md-2">
                                                <input class="form-control" name="name" type="string" placeholder="Enter your name" />
                                                <label for="inputFirstName">Username</label>
                                            </div>
                                            <div class="form-floating mb-3 mb-md-2">
                                                <select class="form-select" style="width: 100%"name="role" aria-label="Default select example">
                ...
                <footer class="py-4 bg-light mt-auto">
                    <div class="container-fluid px-4">
                        <div class="d-flex align-items-center justify-content-between small">
                            <div class="text-muted">Copyright &copy; Kelompok 2 Website 2022</div>
                            <div>
