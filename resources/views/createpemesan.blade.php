        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                <main>
                    ...
                    <form class="border" action="{{ route('postpemesan') }}" method="post" >
                        ...
                        <div class="posisi2">
                              <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="namapemesan" placeholder="Inputkan Nama Pemesan">
                              </div>
                              <div class="mb-3">
                                <label for="formGroupExampleInput2" class="form-label">Alamat Pemesan</label>
                                <input type="text" class="form-control" name="alamat" placeholder="Inputkan Alamat Pemesan">
                              </div>
                              <button type="submit" class="btn btn-outline-primary posisi3" >Next</button>
                        </div>
                    </form>
                </main>
            </div>
