    ...
    <div id="layoutSidenav">
        ...
        <div id="layoutSidenav_content">
            <main>
                ...
                <form class="border" action="{{ route('tambahdatapegawai') }}" method="post">
                    {{ csrf_field() }}
                    ...
                    <div class="posisi2">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="namapegawai"
                                placeholder="Inputkan Nama Pegawai">
                        </div>
                        <div class="mb-3">
                            ...
                            <select class="form-select form-select-sm" style="width: 100%"
                                name="pendidikans_id"aria-label=".form-select-sm example">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select form-select-sm"style="width: 100%"
                                name="posisi"aria-label=".form-select-sm example">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control" name="keahlian" placeholder="Inputkan Keahlian">
                            </div>
                        </div>
