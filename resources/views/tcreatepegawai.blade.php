            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4 font-1"><i class="fa fa-plus pe-2 " aria-hidden="true"></i>Edit Data</h1>
                        {{-- <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Dashboard</li>
                        </ol> --}}
                    </div>
                    <form class="border" action="/updatedatapegawai/{{ $postdata->id }}" method="post" >
                        {{ csrf_field() }}
                        <h1 class="font-1 mt-4 ">Edit Data Pegawai</h1>
                        <div class="posisi2">
                            <div class="mb-3">
                                <label for="formGroupExampleInput" class="form-label">Nama Pegawai</label>
                                <input type="text" class="form-control" name="namapegawai" placeholder="Inputkan Nama Pegawai" value="{{ $postdata->namapegawai }}">
                              </div>
                              <div class="mb-3">
                                <label for="formGroupExampleInput2" class="form-label">Pendidikan</label>
                                <select class="form-select form-select-sm" style="width: 100%" name="pendidikans_id"aria-label=".form-select-sm example" >
                                    <option selected>{{ $postdata->pendidikans_id }}</option>
                              ...
                              <div class="mb-3">
                                ...
                                <select class="form-select form-select-sm" style="width: 100%" name="posisi"aria-label=".form-select-sm example">
                                    <option selected>{{ $postdata->posisi }}</option>
                              ...
                              <div class="mb-3">
                                <label for="formGroupExampleInput2" class="form-label">Keahlian</label>
                                <div class="input-group">
                                    <input type="text" class="form-control" name="keahlian" placeholder="Inputkan Keahlian" value="{{ $postdata->keahlian }}">
                                    {{-- <input class="form-control" aria-label="With textarea" type="text" class="form-control" name="keahlian" placeholder="{{ $postdata->keahlian }}" value={{ $postdata->keahlian }}></input> --}}
                                  </div>
                              </div>
