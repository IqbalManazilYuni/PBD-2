            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4 font-1"><i class="fa fa-plus pe-2 " aria-hidden="true"></i>Ambil Barang</h1>
                        {{-- <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Dashboard</li>
                        </ol> --}}
                    </div>
                    <form class="border" action="/ambilbarangkeluar/{{ $barang->id }}" method="post" >
                        ...
                        @endif
                        <h1 class="font-1 mt-4 ">Ambil Barang</h1>
                        <div class="posisi2">
                            <div class="mb-3">
                                <label for="formGroupExampleInput2" class="form-label">Id Barang</label>
                                <input type="number" class="form-control" name="idbarang" placeholder="Inputkan Primary Key Barang" value = "{{ $barang->id }}" readonly>
                              </div>
                              <div class="mb-3">
                                <label for="formGroupExampleInput2" class="form-label">Nama Barang</label>
                                <input type="text" class="form-control" name="namabarangkeluar" placeholder="Inputkan Nama Barang" value = "{{ $barang->namabarang }}"readonly>
                              </div>
                              <div class="mb-3">
                                <label for="formGroupExampleInput2" class="form-label">Harga Barang</label>
                                <input type="number" class="form-control" name="hargabarangkeluar" placeholder="Inputkan Harga Barang"value = "{{ $barang->hargabarang }}"readonly>
                              </div>
                              <div class="mb-3">
                                <label for="formGroupExampleInput2" class="form-label">Jumlah Barang</label>
                                <input type="number" class="form-control" name="jumlahbarangkeluar" placeholder="Inputkan Jumlah Barang">
                              </div>
                              <button type="submit" class="btn btn-outline-primary posisi3" >Ambil</button>
                        </div>
                    </form>
                </main>
            </div>
