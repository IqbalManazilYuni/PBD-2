    ...
    <div id="layoutSidenav">
        ...
        <div id="layoutSidenav_content">
            <main>
                ...
                <form class="border" action="/updatedatastatus/{{ $posttransaksi->id }}" method="post">
                    {{ csrf_field() }}
                    <h1 class="font-1 mt-4 ">Create Data Pegawai</h1>
                    <div class="posisi2">
                        <div class="mb-3">
                            <label for="formGroupExampleInput" class="form-label">No Faktur</label>
                            <input type="text" class="form-control" name="NoFaktur" placeholder="Inputkan No Faktur" value={{ $posttransaksi->NoFaktur }} readonly>
                        </div>
                        <div class="mb-3">
                            ...
                            <select class="form-select form-select-sm" style="width: 100%"
                                ...
                                <option selected>{{ $posttransaksi->status }}</option>
                                <option value="Sudah Di Proses">Sudah Di Proses</option>
                            </select>
                        </div>
                        <button type="submit" class="btn btn-outline-primary posisi3">Edit</button>
                    </div>
                </form>
            </main>
        </div>
