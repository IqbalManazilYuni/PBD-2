        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                <main>
                    ...
                    <form class="border">
                        <div>
                            <h1 class="mt-4 font-1">List Data Pegawai</h1>
                        </div>
                        <div class="row">
                              <div class="col">
                                <div class="d-flex align-items-center justify-content-between mt-4 mb-0 posisi6A">
                                    <a class="btn btn-info posisi5A" href="{{ route('exportpdfpegawai') }}">Export </a>
                                </div>
                              </div>

                              <div class="col">
                                <div class="d-flex align-items-center justify-content-between mt-4 mb-0 posisi6">
                                    <a class="btn btn-primary posisi5" href="{{ route('tambahpegawai') }}">Tambah</a>
                                </div>
                              </div>
                            </div>
                        @if (session('sukses'))
                                    ...
                                    <tbody>
                                        ...
                                        @endphp
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $post->keahlian}}</td>
                                                <td>
                                                    <a href="/deletedatapegawai/{{ $post->id }}"class="btn btn-danger">Delete</a>
                                                    <a href="/tampildatapegawai/{{ $post->id }}" class="btn btn-success">Edit</a>
                                                </td>
                                              </tr>
                                            @endforeach
                                    </tbody>
