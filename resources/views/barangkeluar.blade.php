            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4 font-1"><i class="fa fa-plus pe-2 " aria-hidden="true"></i>Data Barang Keluar</h1>
                    ...
                    <form class="border">
                        <div>
                            <h1 class="mt-4 font-1">List Data Barang Keluar</h1>
                        </div>
                        <div class="container">
                            <div class="row">
                              <div class="col">
                                <div class="d-flex align-items-center justify-content-between mt-4 mb-0 posisi6A">
                                    <a class="btn btn-info posisi5A" href="{{ route('exportpdfbarangkeluar') }}">Export </a>
                                </div>
                              </div>
                            </div>
                          </div>
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        ...
                                        $no = 1;
                                        @endphp
                                            @foreach ($postbarangkeluar as $post)
                                            <tr>
                                                <td>{{ $no++}}</td>
                                                <td>{{ $post->id}}</td>
                                                <td>{{ $post->namabarangkeluar}}</td>
                                                <td>{{ $post->hargabarangkeluar}}</td>
                                                <td>{{ $post->jumlahbarangkeluar}}</td>
                                            </tr>
                                            @endforeach
                                    </tbody>
                                </table>
